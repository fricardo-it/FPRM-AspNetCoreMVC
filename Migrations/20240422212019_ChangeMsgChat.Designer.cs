...
namespace FPRMAspNetCoreMVC.Migrations
{
    ...
    [Migration("20240422212019_ChangeMsgChat")]
    partial class ChangeMsgChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FPRMAspNetCoreMVC.Models.Reply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FPRMAspNetCoreMVC.Models.Reply", b =>
                {
                    b.HasOne("FPRMAspNetCoreMVC.Models.Message", "ParentMessage")
                        .WithMany("Replies")
