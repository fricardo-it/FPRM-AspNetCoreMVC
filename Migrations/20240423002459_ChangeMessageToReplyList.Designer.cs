...
namespace FPRMAspNetCoreMVC.Migrations
{
    ...
    [Migration("20240423002459_ChangeMessageToReplyList")]
    partial class ChangeMessageToReplyList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Reply", b =>
                {
                    ...
                    b.Property<Guid?>("SenderReplyIdId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FPRMAspNetCoreMVC.Models.Message", b =>
                {
                    ...
                    b.HasOne("FPRMAspNetCoreMVC.Models.User", "SenderMsg")
                        .WithMany()
                        .HasForeignKey("SenderMsgId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Building");

                    b.Navigation("SenderMsg");
                });
            ...
            modelBuilder.Entity("Reply", b =>
                {
                    ...
                    b.HasOne("FPRMAspNetCoreMVC.Models.User", "SenderReplyId")
                        .WithMany()
                        .HasForeignKey("SenderReplyIdId");

                    b.Navigation("SenderReplyId");
                });
